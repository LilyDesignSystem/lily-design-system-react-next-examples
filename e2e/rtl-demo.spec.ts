...
// for the Svelte and nunjucks-eleventy apps: this app's prePaint script
// (app/layout.tsx) creates the managed theme <link data-lily-theme-picker="theme">
// before hydration, but the stylesheet it points at can still finish
// loading after page.goto() resolves. waitForTheme() below waits for the
// managed link's sheet to populate, then two animation frames, before
// anything CSS-dependent runs.
