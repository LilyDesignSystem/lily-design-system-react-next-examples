export const componentDemos: Record<string, string> = {
  ...
  'answer': '<div class="answer" aria-label="an answer is anything that responds to a question, request, action, etc."><p>Yes, the appointment is confirmed.</p></div>',
  ...
  'comment': '<div class="comment" aria-label="a comment is anything that expresses an opinion, observation, explanation, etc."><header>Jane Doe — <time>2 hours ago</time></header><p>Great work on this!</p></div>',
  ...
  'question': '<div class="question" aria-label="a question is anything that asks for information, invites a response, tests knowledge, etc."><p>Would you like to confirm the appointment?</p></div>',
