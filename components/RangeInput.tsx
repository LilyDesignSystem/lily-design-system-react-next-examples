...
//   value — number, default 50. Current numeric value; bindable with value + onChange.
...
//
// Syntax:
//   <RangeInput label="Volume" value={value} onChange={setValue} />
//
// Examples:
//
//   <RangeInput label="Volume" value={value} onChange={setValue} min={0} max={100} />
//
//
