...
//   children — ReactNode, required. The banner box content.
...
//   - Consumer applies display: flex; flex-direction: row; to .banner-box
//
// References:
...
export default function BannerBox({
    ...
    return (
        <div
            className={`banner-box ${className}`}
            aria-label={label}
            {...restProps}
        >
            {children}
