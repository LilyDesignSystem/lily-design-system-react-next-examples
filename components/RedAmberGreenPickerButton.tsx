...
export interface RedAmberGreenPickerButtonProps {
    className?: string;
...
export default function RedAmberGreenPickerButton({
    className = "",
    value,
    label,
    selected = false,
    ...
    onClick = undefined,
    ...restProps
}: RedAmberGreenPickerButtonProps) {
    return (
        <button
        className={`red-amber-green-picker-button ${className}`}
        type="button"
        aria-label={label}
