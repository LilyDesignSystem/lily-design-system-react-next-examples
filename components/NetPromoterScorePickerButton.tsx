...
export interface NetPromoterScorePickerButtonProps {
    className?: string;
...
export default function NetPromoterScorePickerButton({
    className = "",
    value,
    label,
    selected = false,
    ...
    onClick = undefined,
    ...restProps
}: NetPromoterScorePickerButtonProps) {
    return (
        <button
        className={`net-promoter-score-picker-button ${className}`}
        type="button"
        aria-label={label}
