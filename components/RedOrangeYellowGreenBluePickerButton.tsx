...
export interface RedOrangeYellowGreenBluePickerButtonProps {
    className?: string;
...
export default function RedOrangeYellowGreenBluePickerButton({
    className = "",
    value,
    label,
    selected = false,
    ...
    onClick = undefined,
    ...restProps
}: RedOrangeYellowGreenBluePickerButtonProps) {
    return (
        <button
        className={`red-orange-yellow-green-blue-picker-button ${className}`}
        type="button"
        aria-label={label}
