...
export interface FiveStarRatingPickerButtonProps {
    className?: string;
...
export default function FiveStarRatingPickerButton({
    className = "",
    value,
    label,
    selected = false,
    ...
    onClick = undefined,
    ...restProps
}: FiveStarRatingPickerButtonProps) {
    return (
        <button
        className={`five-star-rating-picker-button ${className}`}
        type="button"
        aria-label={label}
