...
//
// Syntax:
//   <SlovenskoPasInput label="Slovak Passport" value={value} onChange={setValue} />
//
// Accessibility:
...
export interface SlovenskoPasInputProps {
    className?: string;
...
export default function SlovenskoPasInput({
    className = "",
    label,
    value = "",
    required = false,
    ...
    onChange,
    ...restProps
}: SlovenskoPasInputProps) {
    return (
        <input
        className={`slovensko-pas-input ${className}`}
        type="text"
        aria-label={label}
        autoComplete="off"
