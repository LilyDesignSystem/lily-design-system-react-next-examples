...
export interface FiveFaceRatingPickerButtonProps {
    className?: string;
...
export default function FiveFaceRatingPickerButton({
    className = "",
    value,
    label,
    selected = false,
    ...
    onClick = undefined,
    ...restProps
}: FiveFaceRatingPickerButtonProps) {
    return (
        <button
        className={`five-face-rating-picker-button ${className}`}
        type="button"
        aria-label={label}
